...
export class HuespedService {
  ...
  public listarHuespedes(page: number): Observable<Huesped[]> {
    return this.http
      .get(this.urlEndPoint + 'listarHuespedes/page/' + page, {
  ...
  createHuesped(huesped: Huesped): Observable<Huesped> {
    return this.http
      .post<Huesped>(this.urlEndPoint + 'crearHuesped', huesped, {
        headers: this.addAuthorizationHeader(),
      })
      .pipe(
  ...
  viewHuesped(codHuesped: any): Observable<Huesped> {
    return this.http
      .get<Huesped>(`${this.urlEndPoint + 'verhuesped'}/${codHuesped}`, {
        headers: this.addAuthorizationHeader(),
      })
      .pipe(
        catchError((e) => {
  ...
  updateHuesped(huesped: Huesped): Observable<Huesped> {
    return this.http
      .put<Huesped>(
        `${this.urlEndPoint + 'actualizarHuesped'}/${huesped.codHuesped}`,
        huesped,
        { headers: this.addAuthorizationHeader() }
      )
      .pipe(
  ...
  public deleteHuesped(codHuesped: any): Observable<any> {
    return this.http
      .delete<any>(`${this.urlEndPoint + 'eliminarhuesped'}/${codHuesped}`, {
        headers: this.addAuthorizationHeader(),
      })
      .pipe(
        catchError((e) => {
